...
def main():
    ...
    def get_estimator0(x, r, v1):
        return Estimator(QinferDist2D(omegas, v1s, prior, prior.size), TwoPointChooser(32))
    def get_estimator1(x, r, v1):
        return Estimator(GridDist2D(omegas, v1s, prior), TwoPointChooser(32))
    def get_estimator2(x, r, v1):
    ...
    for get_est in [get_estimator0, get_estimator1, get_estimator2, get_estimator3]:
